...
PointToPointNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointNetDevice")
    ...
    .AddTraceSource ("MacTxEnqueue", 
                     "Trace source indicating a packet has arrived "
                     "for transmission by this device",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_macTxEnqueueTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacTxDequeue", 
                     "Trace source indicating a packet has arrived "
                     "for transmission by this device",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_macTxDequeueTrace),
                     "ns3::Packet::TracedCallback")                         
    ...
    m_currentPkt (0)
{
  ...
  // m_ofstream.open("log_p2p.csv", std::ios::out | std::ios::app);
}
