...
#ifndef GENERALIZED_EXPONENTIAL_H
#define GENERALIZED_EXPONENTIAL_H
 ...
 * \defgroup onoff GeneralizedExponentialTraffic
 *
...
*/
class GeneralizedExponentialTraffic : public Application 
{
public:
  /**
  ...
  GeneralizedExponentialTraffic ();

  virtual ~GeneralizedExponentialTraffic();
...
private:
  ...
  std::string     m_pktSizeDistrubution;
  uint32_t        m_minPktSize;      //!< Min Size of packets
  uint32_t        m_maxPktSize;      //!< Max Size of packets
  Ptr<ExponentialRandomVariable> expRanVar;
  Ptr<UniformRandomVariable> uniRanVar;
  Ptr<UniformRandomVariable> packetSizeUni;
  Ptr<ExponentialRandomVariable> packetSizeExp;
  uint32_t        state_burst;
  uint32_t        sum_burst;
  uint32_t        count_burst;
  int64_t         sum_packetsize;
  int64_t         sum_packetnum;
  int64_t         sum_time;
  double          p_burst;
...
#endif /* GENERALIZED_EXPONENTIAL_H */
