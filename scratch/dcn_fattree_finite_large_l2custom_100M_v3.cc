...
int main(int argc, char *argv[])
{
	...
	// int packetSize = 500;   // over write via command line
	// int minPacketSize = 500;
	// int maxPacketSize = 500;
	//	double burstProbability = 0.0;  //use p_burst instead
    ...
    packetSize = (minPacketSize + maxPacketSize) / 2; 
	...
	//	cout << "Source data rate (Default 0.G0 Mbps): " << sourceDataRateBitsPerSec << "\n";
	cout << "Source data rate (Default 0.20 Mbps): " << sourceDataRateBitsPerSec << "\n";
