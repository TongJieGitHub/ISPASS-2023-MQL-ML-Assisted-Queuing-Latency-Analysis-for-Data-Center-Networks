...
int main(int argc, char *argv[])
{
	...
	//	string netProtocol = INTERNET_PROTOCOL_UDP;					// UDP, TCP
	...
	// Parameter adjusment - e.g. Mbps  Gbps
	...
	cout << "Avg PacketSize (Default 1024): " << avgPacketSize << "\n";
	...
	cout << "\t\t---- linkBandwidth= " << linkBandwidthXbps << endl;
